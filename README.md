...
## Запуск при скрипте сборки:
```
Сервер: ./build/server/server <порт>
Клиент B: ./build/client_b/client_b <IP_сервера> <порт>
Клиент A: ./build/client_a/client_a <IP_сервера> <порт>
```
